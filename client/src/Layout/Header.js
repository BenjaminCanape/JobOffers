          ...
          <Navbar expand="md">
            <NavbarBrand tag={Link} to="/">
              ...
              {this.getConnectedUser() ? (
                <span>Bonjour {this.getConnectedUser().firstName}, </span>
              ) : (
                <span>Site d'offres d'emploi</span>
              )}
            </NavbarBrand>
            ...
            <Collapse isOpen={this.state.isOpen} navbar>
              <Nav className="ml-auto" navbar>
                {isRecruiter && (
                  <NavLink tag={Link} to="/myOffers">
                    <FontAwesomeIcon icon={list} /> Mes offres
                  </NavLink>
                )}
                {isRecruiter && (
                  <NavLink tag={Link} to="/add">
                    <FontAwesomeIcon icon={plusSquare} /> Ajouter
                  </NavLink>
                )}
                {this.state.userLoggedIn && (
                  <NavLink tag={Link} to="/myprofile">
                    <FontAwesomeIcon icon={userCircle} /> Mon profil
                  </NavLink>
                )}
                {!this.state.userLoggedIn && (
